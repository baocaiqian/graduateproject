...
<head>
	...
	<title>上传图片</title>
	<link rel="stylesheet" type="text/css" href="${ctx }/statics/base/css/normalize.css" />
	<link rel="stylesheet" type="text/css" href="${ctx }/statics/base/css/demo.css">
	<link href="${ctx }/statics/base/css/styles.imageuploader.css" rel="stylesheet" type="text/css">
</head>
<body>
<div id="mysesisgn">
...
<div style="position: relative;">
	...
	<script src="${ctx }/statics/base/js/jquery-1.11.0.min.js" type="text/javascript"></script>
	<script src="${ctx }/statics/base/js/jquery.imageuploader.js" type="text/javascript"></script>
